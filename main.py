...
def run():
    ...
    while selected_option != '7':
        if selected_option == '1':
            present_value = int(input(present_value_label))
            interest = int(input(interest_label))
            periods = int(input(periods_label))
        ...
        if selected_option == '2':
            present_value = int(input(present_value_label))
            future_value = int(input(future_value_label))
            periods = int(input(periods_label))
        ...
        if selected_option == '6':
            nominal_rate = int(input('Ingrese el porcentaje de su tasa nominal mensual: '))
